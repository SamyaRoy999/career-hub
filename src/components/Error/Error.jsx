        ...
        <div>
            <div className="bg-gray-100 h-screen justify-center">
                ...
                <center className="mt-6">
                    <NavLink to='/root' className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back </NavLink>
                </center>
            </div>
        </div>
    )
